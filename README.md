...
- [Введення](#Введення-top)
  - [Помітка на видалення/фізичне видалення записів з довідників](#Помітка-на-видалення/фізичне-видалення-записів-з-довідників-top)
...
### Помітка на видалення/фізичне видалення записів з довідників [:top:](#Зміст)
...
Довідник | Опис
-|-
`children_groups` | Групи дітей
`children_categories` | Категорії дітей
`products` | Продукти харчування

Значення `is_del` | Опис
-|-
`true` | Встановити помітку на видалення
`false` | Зняти помітку на видалення
`null` | Фізично видалити значення
