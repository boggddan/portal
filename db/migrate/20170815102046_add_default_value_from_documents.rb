class AddDefaultValueFromDocuments < ActiveRecord::Migration[5.1]
  def change
    ...
    change_column_comment( :menu_requirements, :number_sap, 'Номер документа 1С план' )
    change_column_comment( :menu_requirements, :number_saf, 'Номер документа 1С факт' )
    change_column_comment( :menu_requirements, :splendingdate, 'Дата списання' )
    change_column_comment( :menu_requirements, :date_sap, 'Дата документа 1С план' )
    change_column_comment( :menu_requirements, :date_saf, 'Дата документа 1С факт' )
    change_column_comment( :menu_requirements, :is_del_plan_1c, 'Ознака видалення 1С плана' )
    change_column_comment( :menu_requirements, :is_del_fact_1c, 'Ознака видалення 1С факта' )
    ...
    change_column_comment( :institution_orders, :number_sa, 'Номер документа 1С' )
    change_column_comment( :institution_orders, :date_sa, 'Дата документа 1С' )
    change_column_comment( :institution_orders, :is_del_1c, 'Ознака видалення 1С' )
    ...
    change_column_comment( :io_corrections, :number_sa, 'Номер документа 1С' )
    change_column_comment( :io_corrections, :date_sa, 'Дата документа 1С' )
    change_column_comment( :io_corrections, :is_del_1c, 'Ознака видалення 1С' )
    ...
    change_column_comment( :receipts, :number_sa, 'Номер документа 1С' )
    change_column_comment( :receipts, :date_sa, 'Дата документа 1С' )
    change_column_comment( :receipts, :is_del_1c, 'Ознака видалення 1С' )
    ...
    change_column_comment( :timesheets, :number_sa, 'Номер документа 1С' )
    change_column_comment( :timesheets, :date_sa, 'Дата документа 1С' )
    change_column_comment( :timesheets, :is_del_1c, 'Ознака видалення 1С' )
    ...
    change_column_comment( :supplier_orders, :number, 'Номер документа 1С' )
    change_column_comment( :supplier_orders, :date, 'Дата документа 1С' )
    change_column_comment( :supplier_orders, :is_del_1c, 'Ознака видалення 1С' )
