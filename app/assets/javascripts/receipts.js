$( document ).on('turbolinks:load', function() {
  ...
  if ( $('#receipts').length ) {
    ...
    if (sessionStorage.receipts_supplier_name_value) { $('#supplier_name').data('value', sessionStorage.receipts_supplier_name_value) };
    ...
    function filterTableSupplierOrders() {
      ...
      var $path_ajax = $date_start.data('ajax-path')+'?'+$date_start.attr('name')+'='+$date_start_val+'&'+$date_end.attr('name')+'='+$date_end_val+
        '&'+$supplier_name.data('ajax-param') +'='+$supplier_name_value;
    ...
    $('#create_receipt').click( function() {
      ...
      var $contract_number = $('#contract_number');
      var $path_ajax = $this.data('ajax-path')+$('#table_supplier_orders tbody tr.selected').data('id')+'&'+$contract_number.attr('name')+'='+$contract_number.val();
    ...
    $(document).on('change', '#contract_number', function() {
      ...
      if ( $this.val() ) {
        sessionStorage.receipts_contract_number = $this_val;
      } else {
        sessionStorage.removeItem('receipts_contract_number');
      }
